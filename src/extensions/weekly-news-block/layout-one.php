...
$imgColWidth = $total_width * 0.33 - 10;
$textColWidth = $total_width * 0.66 - 10;
    ...
    <?php foreach ($posts as $post) { ?>
        ...
        <tr>
            <td valign="top" style="padding: 20px 0 0 0;">
                ...
                <?php if ($media) { ?>
                    <table width="<?php echo $imgColWidth ?>" cellpadding="0" cellspacing="0" border="0" align="left" class="responsive">
                        <tr>
                ...
                <table width="<?php echo $media ? $textColWidth : '100%' ?>" cellpadding="0" cellspacing="0" border="0" class="responsive" align="right"><tr><td>
