...
define( 'CUSTOM_METABOXES_DIR', get_template_directory_uri() . '/src/metaboxes' );
...
class Custom_Add_Meta_Box {
	...
	public function __construct( $id, $title, $fields, $page, $location, $priority ) {
		if (null == $location) {
			$location = "normal";
		}
	...
	function add_box() {
		foreach ( $this->page as $page ) {
			add_meta_box( $this->id, $this->title, array( $this, 'meta_box_callback' ), $page, $this->location, $this->priority );
		}
	}
